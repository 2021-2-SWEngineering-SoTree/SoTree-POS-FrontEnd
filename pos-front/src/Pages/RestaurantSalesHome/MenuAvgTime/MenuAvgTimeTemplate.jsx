    ...
    const getCustomerAvgTime = async() => {
        ...
        try {
            ...
            await axios.post('http://localhost:8080/payment/getCustomerAvgTime', managerId, {
                ...
                const data = res.data;
                let rightCells = [
                    ['전체', data['allDay'][0] !== undefined ? data['allDay'][0].lunchAvg.toFixed(2) :0, data['allDay'][0] !== undefined ? data['allDay'][0].dinnerAvg.toFixed(2):0, -data['allDay'][0] !== undefined ? data['allDay'][0].totalAvg.toFixed(2) :0],
                    ['평일', data['weekday'][0] !== undefined ? data['weekday'][0].lunchAvgWeekday.toFixed(2) :0, data['weekday'][0] !== undefined ?  data['weekday'][0].dinnerAvgWeekday.toFixed(2) :0, data['weekday'][0] !== undefined ? data['weekday'][0].totalAvgWeekday.toFixed(2) :0],
                    ['주말', data['weekend'][0] !== undefined  ? data['weekend'][0].lunchAvgWeekend.toFixed(2) :0, data['weekend'][0] !== undefined ? data['weekend'][0].dinnerAvgWeekend.toFixed(2) :0, data['weekend'][0] !== undefined ?  data['weekend'][0].totalAvgWeekend.toFixed(2) :0],
                    ['일요일', data['dayLunch'][6] !== undefined ?   data['dayLunch'][6].timestampdiff.toFixed(2):0, data['dayDinner'][6] !== undefined ?  data['dayDinner'][6].timestampdiff.toFixed(2):0,   data['dayAllTime'][6] !== undefined ? data['dayAllTime'][6].timestampdiff.toFixed(2) :0],
                    ['월요일', data['dayLunch'][1] !== undefined ?   data['dayLunch'][1].timestampdiff.toFixed(2):0, data['dayDinner'][1] !== undefined ?  data['dayDinner'][1].timestampdiff.toFixed(2):0,   data['dayAllTime'][1] !== undefined ? data['dayAllTime'][1].timestampdiff.toFixed(2) :0],
                    ['화요일', data['dayLunch'][0] !== undefined ?   data['dayLunch'][0].timestampdiff.toFixed(2):0, data['dayDinner'][0] !== undefined ?  data['dayDinner'][0].timestampdiff.toFixed(2):0,   data['dayAllTime'][0] !== undefined ? data['dayAllTime'][0].timestampdiff.toFixed(2) :0],
                    ['수요일', data['dayLunch'][2] !== undefined ?   data['dayLunch'][2].timestampdiff.toFixed(2):0, data['dayDinner'][2] !== undefined ?  data['dayDinner'][2].timestampdiff.toFixed(2):0,   data['dayAllTime'][2] !== undefined ? data['dayAllTime'][2].timestampdiff.toFixed(2) :0],
                    ['목요일', data['dayLunch'][3] !== undefined ?   data['dayLunch'][3].timestampdiff.toFixed(2):0, data['dayDinner'][3] !== undefined ?  data['dayDinner'][3].timestampdiff.toFixed(2):0,   data['dayAllTime'][3] !== undefined ? data['dayAllTime'][3].timestampdiff.toFixed(2) :0],
                    ['금요일', data['dayLunch'][4] !== undefined ?   data['dayLunch'][4].timestampdiff.toFixed(2):0, data['dayDinner'][4] !== undefined ?  data['dayDinner'][4].timestampdiff.toFixed(2):0,   data['dayAllTime'][4] !== undefined ? data['dayAllTime'][4].timestampdiff.toFixed(2) :0],
                    ['토요일', data['dayLunch'][5] !== undefined ?   data['dayLunch'][5].timestampdiff.toFixed(2):0, data['dayDinner'][5] !== undefined ?  data['dayDinner'][5].timestampdiff.toFixed(2):0,   data['dayAllTime'][5] !== undefined ? data['dayAllTime'][5].timestampdiff.toFixed(2) :0],
                ];
